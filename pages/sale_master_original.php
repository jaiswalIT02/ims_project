                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="unit" id="unit" class="form-control" >
                                        ...
                                        <?php 
                                            $sql = "SELECT `unitname` FROM `unit_master` GROUP BY `unitname` " ; 
                                            $qry = mysqli_query($conn ,  $sql);
                                            while($row = mysqli_fetch_array($qry))
                                            {
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="total_price" name="price"  value="0" class="form-control" readonly>                       
                                </div>
                            </div><br><br>

                            <div class="col-md-2 mx-auto" style="margin-top:2.5%;">
                                    <button type="submit" name="submit" onclick="add_session();" class="btn btn-primary text-center" > + Add </button>    
                            </div>
